...
class RestrictionCreatorTest < ActiveSupport::TestCase
  ...
  test 'Allow list parent restriction should ensure location has a parent of a type indicated in an allow list' do
    building.reload
  ...
  test "Deny list parent restriction should ensure location does not have a parent
    of a type indicated in a black list" do
