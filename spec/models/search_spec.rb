...
RSpec.describe Search, type: :model do
  ...
  context 'Results' do
    ...
    let!(:location_freezer1) do
      create(:location, name: 'Freezer 1', location_type: location_type_room, parent: location_building)
    end
    let!(:location_freezer2) do
      create(:location, name: 'Freezer 2', location_type: location_type_room, parent: location_building)
    end
    let!(:location_shelf123) do
      create(:location, name: 'Shelf 123', location_type: location_type_freezer, parent: location_freezer1)
    end
