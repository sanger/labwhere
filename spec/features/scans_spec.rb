...
# (l2) As a Sample Management RA I want to scan labware into and out of a
# location to avoid misplacing biomaterial and delaying pipeline processing
...
RSpec.describe 'Scans', type: :feature do
  ...
  it 'displays duplicate barcodes in an error color', js: true do
    ...
    find('.CodeMirror').click # Focus on the CodeMirror editor
    find('.CodeMirror').send_keys(:enter)
