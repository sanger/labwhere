...
# Active Storage `has_many_attached` relationships will default to
# replacing the current collection instead of appending to it.
# Thus, to support submitting an empty collection, the `file_field`
# helper will render an hidden field `include_hidden` by default when
