...
ActiveRecord::Schema.define(version: 2020_08_24_095014) do
  ...
  create_table "audits", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.string "uuid", limit: 36, comment: 'Unique identifier for this Audit. Added to send to Events Warehouse.'
  ...
  create_table "labwares", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.string "uuid", limit: 36, comment: "Unique identifier for this Labware. Added to send to Events Warehouse. Doesn't match up with Sequencescape or any other app."
  ...
  create_table "locations", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.string "uuid", limit: 36, comment: 'Unique identifier for this Location. Added to send to Events Warehouse.'
